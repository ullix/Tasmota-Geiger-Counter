...
Take an ESP32 and install a generic Tasmota (currently using version 15.2.0), Upload a piece of Tasmota-App and you have the counter and saver for Geiger data, to which you communicate solely via WiFi.   
...
This repository has the Tasmota-App code ~~'geiger.tapp'~~ '**geigerlog.tapp**'. For the full GeigerLog code see https://sourceforge.net/projects/geigerlog/ . The latest pre-release can be found here: https://sourceforge.net/p/geigerlog/discussion/devel2/
